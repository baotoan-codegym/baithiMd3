package ktmd3codegym.app.controller;

import ktmd3codegym.app.model.Category;
import ktmd3codegym.app.model.Product;
import ktmd3codegym.app.service.categoryservice.CategoryService;
import ktmd3codegym.app.service.categoryservice.ICategoryService;
import ktmd3codegym.app.service.productservice.IProductService;
import ktmd3codegym.app.service.productservice.ProductService;
...
public class ProductServlet extends HttpServlet {
    ...
    private void showListProduct(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            RequestDispatcher rd = req.getRequestDispatcher("/product/listProduct.jsp");
            rd.forward(req,resp);
        }  catch (Exception e) {
            try {
                resp.sendRedirect("product/error.jsp");
